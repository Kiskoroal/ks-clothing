    ...
    $.each(data.menus, function(i, menu) {
        if (menu.selected) {
            ...
            if (menu.label == "Clothing") {
                ...
                $("#modelopton").css("display", "none");
                $("#fatheroption").css("display", "none");
                $("#parentoption").css("display", "none");
                $("#motheropton").css("display", "none");
            } else {
                $("#faceoption").css("display", "block");
                $("#modelopton").css("display", "block");
                $("#fatheroption").css("display", "block");
                $("#parentoption").css("display", "block");
                $("#motheropton").css("display", "block");
            }
